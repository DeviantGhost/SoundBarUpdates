...
//  SoundBar
//
//  Created by Justin Cose on 2021-08-21.
...
class AffiliatesCell: BaseCellNode {
    ...
    init(audio: AudioHandler, animationHandle: SongsAnimationHandler, userInfo: ProfileHeader) {
        super.init()
    ...
    private func setupNodes() {
        ...
        artistImage.addTarget(self, action: #selector(soundbarArtistClicked), forControlEvents: .touchUpInside)
    ...
    @objc func soundbarArtistClicked() {
        artistProfile = true
...
//  SoundBar
//
//  Created by Carlon Rosales on 9/5/21.
