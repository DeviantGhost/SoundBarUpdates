...
class SendTop: BaseCellNode {
    ...
    private func setupNodes() {
        ...
        titleText.attributedText = NSAttributedString(string: "New Message", attributes: [NSAttributedString.Key.foregroundColor : UIColor.white, NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14)])
    }
